...
int CScene6::DrawGLScene(void)	// Função que desenha a cena
{
	...
	glBegin(GL_QUADS);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(-150.0f, 0.0f, 0.0f);
	glTexCoord2f(3.0f, 0.0f); glVertex3f(150.0f, 0.0f, 0.0f);
	glTexCoord2f(3.0f, 1.0f); glVertex3f(150.0f, 100.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(-150.0f, 100.0f, 0.0f);
	glEnd();
	glPopMatrix();
